import { ADD_FAVORITES_CITY,
	...
	SHOW_ALERT, SHOW_LOADER } from './actions';

import { ActionType, CityAndLabelType, cityType } from '../Shared/types/types';
...
export const appReduser = (state = initiaState, action: ActionType): InitiaStateType => {
	let city: CityAndLabelType[];
